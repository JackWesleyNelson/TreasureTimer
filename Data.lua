...
M.progress = {
    --["Kuftal Tunnel"] = {current = 24}
}
--Chest and Coffer data taken from LSB: https://github.com/LandSandBoat/server/blob/2964630d48fc8fe66a977ed6c1ceca5fd86aee7a/scripts/globals/treasure.lua
M.chest = {
    [9] = -- PSOXJA
    {
        treasureLvl = 53,
        ...
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.BASTOK, xi.quest.id.bastok.FADED_PROMISES) ==
                        QUEST_ACCEPTED and
    ...
    [151] = -- CASTLE_OZTROJA
    {
        ...
        --[[ misc =
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.JEUNO, xi.quest.id.jeuno.SCATTERED_INTO_SHADOW) ==
                        QUEST_ACCEPTED and
    ...
    [157] = -- MIDDLE_DELKFUTTS_TOWER
    {
        ...
        --[[ misc =
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.JEUNO, xi.quest.id.jeuno.WINGS_OF_GOLD) ==
                        QUEST_ACCEPTED and
    ...
    [161] = -- CASTLE_ZVAHL_BAILEYS
    {
        ...
        --[[ misc =
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.BASTOK, xi.quest.id.bastok.A_TEST_OF_TRUE_LOVE) ==
                        QUEST_ACCEPTED and
    ...
    [193] = -- ORDELLES_CAVES
    {
        ...
        --[[ misc =
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.SIGNED_IN_BLOOD) ==
                        QUEST_ACCEPTED and
            ...
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.JEUNO, xi.quest.id.jeuno.THE_GOBLIN_TAILOR) >=
                        QUEST_ACCEPTED and
    ...
    [197] = -- CRAWLERS_NEST
    {
        ...
        --[[ misc =
        {
            {
                test = function(player)
                    return xi.quest.getVar(player, xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.ENVELOPED_IN_DARKNESS,
                            'Prog') >= 2 and
                        xi.quest.getVar(player, xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.ENVELOPED_IN_DARKNESS,
                            'Time') == 0 and
    ...
    [204] = -- FEIYIN
    {
        ...
        misc =
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.SORCERY_OF_THE_NORTH) ==
                        QUEST_ACCEPTED and
...
M.coffer = {
    ...
    [174] = -- KUFTAL_TUNNEL
    {
        ...
        --[[ misc =
        {
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.OUTLANDS, xi.quest.id.outlands.TRUE_WILL) ==
                        QUEST_ACCEPTED and
            ...
            {
                test = function(player)
                    return player:getQuestStatus(xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.KNIGHT_STALKER) ==
                        QUEST_ACCEPTED and
